...
def color_wheel():
    ...
    color_wheel_img = pygame.image.load(os.path.join("Image samples/Color wheel/color_wheel.png")).convert()
    gray_lvl_img = pygame.image.load(os.path.join("Image samples/Color wheel/gray_level3.png")).convert()
